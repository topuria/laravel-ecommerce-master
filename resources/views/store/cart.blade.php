...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} GEL</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            ...
                            <p>But will add online service soon :) </p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" GEL";
                document.getElementById("totalCost").innerHTML = msg[2]+" GEL";
            }
            });
    ...
    $('.delete_item').click(function () {
        ...
        var serial= $(this).val();   //serial is the forth element of sale column
        var token=$("input[name=_token]").val();
