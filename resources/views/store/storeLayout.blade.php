        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +995-571-16-09-14</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i>nodar.tofuria.1@btu.edu.ge</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i>Tbilisi,Georgia</a></li>
                </ul>
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>For BTU, E-Commerce Project By Nodar Tofuria</p>
